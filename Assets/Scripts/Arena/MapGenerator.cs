...
public class MapGenerator : MonoBehaviour
{
    ...
    public void GenerateMap()
    {
        ...
        for (int i = 0; i < obstacleCount; i++)
        {
            ...
            {
                float obstacleHeight = Mathf.Lerp(currentMap.minObstacleHeight, currentMap.maxObstacleHeght, (float)prng.NextDouble());
                Vector3 obstaclePos = CoordToPos(randomCoord.x, randomCoord.y);

                Transform newObstacle = Instantiate(obstaclePrefab, obstaclePos + Vector3.up * obstacleHeight/2f, Quaternion.identity) as Transform;
        ...
        maskTop.localScale = new Vector3(maxMapSize.x, 1, (maxMapSize.y - currentMap.mapSize.y) / 2f + overlapDebug) * tileSize;
        ...
        maskBottom.localScale = new Vector3(maxMapSize.x, 1, (maxMapSize.y - currentMap.mapSize.y) / 2f + overlapDebug) * tileSize;
    ...
    public class Map
    {
        ...
        public float maxObstacleHeght;
        public Color forgroundColor;
        public Color backgroundColor;
        public bool largeMap;

        public Coord mapCentre { get { return new Coord(mapSize.x / 2, mapSize.y / 2); } }
    }
}
